...
RUN Rscript -e 'devtools::install_version("plyr", version = "1.8.6", repos = "http://cran.us.r-project.org")'
...
RUN Rscript -e 'BiocManager::install("Rdisop")'
...
RUN Rscript -e 'devtools::install_version("dataCompareR", version = "0.1.3", repos = "http://cran.us.r-project.org")'
