multilevelannotationstep4 <- function(outloc, max.mz.diff = 5, max.rt.diff = 30, adduct_table, adduct_weights, filter.by = NA, min_ions_perchem = 1, boostIDs = NA, max_isp = 5, dbAllinf = NA, num_nodes = 2) {
  setwd(outloc)
  ...
  parallel::clusterEvalQ(cl, "get_confidence_stage4")
  parallel::clusterEvalQ(cl, "check_element")
  parallel::clusterEvalQ(cl, "group_by_rt")
  ...
  parallel::clusterExport(cl, "getMolecule", envir = environment())
  parallel::clusterExport(cl, "ldply", envir = environment())
  parallel::clusterExport(cl, "max_isp", envir = environment())
  parallel::clusterExport(cl, "get_confidence_stage4", envir = environment())
  parallel::clusterExport(cl, "min_ions_perchem", envir = environment())
  parallel::clusterExport(cl, "check_element", envir = environment())
  parallel::clusterExport(cl, "group_by_rt", envir = environment())
  parallel::clusterExport(cl, "adduct_table", envir = environment())
  parallel::clusterExport(cl, "adduct_weights", envir = environment())
  parallel::clusterExport(cl, "filter.by", envir = environment())
  parallel::clusterExport(cl, "max_diff_rt", envir = environment())
  parallel::clusterExport(cl, "chemscoremat_highconf", envir = environment())
  parallel::clusterExport(cl, "chemids", envir = environment())
  {
